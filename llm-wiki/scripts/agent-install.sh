...
echo ""
echo "Next: run the onboarding interview to create the wiki:"
echo "  /wiki-onboard   (workflows/onboard.md)"
echo "New sessions will prompt for onboarding automatically until it is done."
